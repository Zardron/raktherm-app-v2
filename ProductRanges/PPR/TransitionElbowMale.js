...
const TransitionElbowMale = () => {
  return (
    <View>
      <ScrollView>
        <Image
          source={{
            uri: "https://www.raktherm.com/mobile_images/product_ranges/PPR//transition-elbow-male.jpg",
          }}
          height={300}
          width={Dimensions.get("window").width}
          alt="transition-elbow-male"
        />
        <DataTable>
          <DataTable.Header>
            <DataTable.Title>
...
export default TransitionElbowMale;
