...
const TransitionPieceRoundMale = () => {
  return (
    <View>
      <ScrollView>
        <Image
          source={{
            uri: "https://www.raktherm.com/mobile_images/product_ranges/PPR//transition-piece-round-male.jpg",
          }}
          height={300}
          width={Dimensions.get("window").width}
          alt="transition-piece-round-male"
        />
        <DataTable>
          <DataTable.Header>
            <DataTable.Title>
...
export default TransitionPieceRoundMale;
