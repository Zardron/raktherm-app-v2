...
const TransitionFemaleTee = () => {
  return (
    <View>
      <ScrollView>
        <Image
          source={{
            uri: "https://www.raktherm.com/mobile_images/product_ranges/PPR//transition-female-tee.jpg",
          }}
          height={300}
          width={Dimensions.get("window").width}
          alt="transition-female-tee"
        />
        <DataTable>
          <DataTable.Header>
            <DataTable.Title>
...
export default TransitionFemaleTee;
