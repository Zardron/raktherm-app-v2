...
const TransitionPPRMaleUnion = () => {
  return (
    <View>
      <ScrollView>
        <Image
          source={{
            uri: "https://www.raktherm.com/mobile_images/product_ranges/PPR//transition-ppr-male-union.jpg",
          }}
          height={300}
          width={Dimensions.get("window").width}
          alt="transition-ppr-male-union"
        />
        <DataTable>
          <DataTable.Header>
            <DataTable.Title>
...
export default TransitionPPRMaleUnion;
