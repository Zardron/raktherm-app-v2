...
const BrassNippleExtension = () => {
  return (
    <View>
      <ScrollView>
        <Image
          source={{
            uri: "https://www.raktherm.com/mobile_images/product_ranges/PPR_IMAGES/pen.png",
          }}
          height={300}
          width={Dimensions.get("window").width}
          alt="bracket-with-clamp"
        />
        <DataTable>
          <DataTable.Header>
            <DataTable.Title>
...
export default BrassNippleExtension;
