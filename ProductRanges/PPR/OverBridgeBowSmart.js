...
const OverBridgeBowSmart = () => {
  return (
    <View>
      <ScrollView>
        <Image
          source={{
            uri: "https://www.raktherm.com/mobile_images/product_ranges/PPR//over-bridge-bow-smart.jpg",
          }}
          height={300}
          width={Dimensions.get("window").width}
          alt="over-bridge-bow-smart"
        />
        <DataTable>
          <DataTable.Header>
            <DataTable.Title>
...
export default OverBridgeBowSmart;
