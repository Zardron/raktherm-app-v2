...
const TransitionElbowFemale = () => {
  return (
    <View>
      <ScrollView>
        <Image
          source={{
            uri: "https://www.raktherm.com/mobile_images/product_ranges/PPR//transition-elbow-female.jpg",
          }}
          height={300}
          width={Dimensions.get("window").width}
          alt="transition-elbow-female"
        />
        <DataTable>
          <DataTable.Header>
            <DataTable.Title>
...
export default TransitionElbowFemale;
